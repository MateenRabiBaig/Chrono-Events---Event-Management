			...
			<div class="row">
				...
				<div class="text-start me-5 p-5">
					...
					<p class="me-5">
						...
						Cross Road, Vijayanagar, Bangalore-560040
					</p>
					<p class="me-5">
						<span class="text-success">Contact Number: </span> +91 1234567890
					</p>
					<p class="me-5">
						<span class="text-success">Mail ID: </span> chronoevents@gmail.com
					</p>
				</div>
